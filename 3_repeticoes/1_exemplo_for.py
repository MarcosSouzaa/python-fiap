# TRABALHANDO COM FOR
'''
Para o comando 'for', criamos uma variável chamada 'numero'e dizemos que, de acordo com
a função 'range()' que permite especificar uma faixa de valores e como será 
incrementada, a variável iniciará com o valor 1 até o valor que for digitado pelo usuário
